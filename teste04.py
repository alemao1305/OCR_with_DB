...
'''def enviar_informacoes_para_banco(car_counter):
    # Coloque aqui o código para enviar as informações para o banco de dados
    # Suponha que você já tenha implementado essa lógica

    # Após enviar as informações, redefina o contador de veículos
...
def handle_vehicle_detection(detections, frame_number):
    ...
    car_counter.update_count(matches, frame_number)  # Chamar update_count uma vez após o loop
